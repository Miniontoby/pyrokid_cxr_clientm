"""com.rokid.cxr.client-m:1.0.9 - extend/callbacks/UnsyncNumResultCallback.java in Python"""
...
class UnsyncNumResultCallback(ABC):
	...
	@abstractmethod
	def onUnsyncNumResult(self, cxrStatus: ValueUtil.CxrStatus, audioNum: int, pictureNum: int, videoNum: int) -> None: pass
